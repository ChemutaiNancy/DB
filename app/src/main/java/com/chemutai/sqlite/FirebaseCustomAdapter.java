...
public class FirebaseCustomAdapter extends RecyclerView.Adapter<FirebaseCustomAdapter.MyViewHolder> {

    ArrayList<Customer> customerList;
    Context context;
    DatabaseReference ref;

    public FirebaseCustomAdapter(ArrayList<Customer> customerList, Context context) {
    ...
    @NonNull
    @Override
    public FirebaseCustomAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_delete, parent, false);//display(inflate)
        return new MyViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull FirebaseCustomAdapter.MyViewHolder holder, int position) {
            ...
            public void onClick(View view) {
                ...
                dialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ref.child(c.getId()+"").setValue(null);//delete a record in firebase db
